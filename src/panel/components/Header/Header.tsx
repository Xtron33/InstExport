...
export const Header = () => {
  ...
  return (
    <header className={styles.header}>
      <div>
        <h1 className={styles.title}>InstExport</h1>
        <p className={styles.subtitle}>{t('header.subtitle')}</p>
      </div>
      <div className={styles.languages} role="group" aria-label={t('header.language')}>
        <Button
          className={styles.flag}
          ariaLabel={t('header.english')}
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M9.56445 9.99995H19.9992C19.9992 9.09737 19.8789 8.22299 19.6547 7.39124H9.56445V9.99995Z"
              fill="#D80027"
            />
            <path
              d="M9.56445 4.78266H18.5315C17.9193 3.78375 17.1366 2.90083 16.2241 2.17395H9.56445V4.78266Z"
              fill="#D80027"
            />
            <path
              d="M10.0002 20C12.3537 20 14.5169 19.1865 16.2251 17.826H3.77539C5.48359 19.1865 7.64676 20 10.0002 20Z"
              fill="#D80027"
            />
            <path
              d="M1.46699 15.2174H18.5315C19.023 14.4154 19.4041 13.5389 19.6548 12.6086H0.34375C0.594414 13.5389 0.975547 14.4154 1.46699 15.2174Z"
              fill="#D80027"
            />
            <path
        ...
        <Button
          className={styles.flag}
          ariaLabel={t('header.russian')}
          pressed={i18n.resolvedLanguage === 'ru'}
